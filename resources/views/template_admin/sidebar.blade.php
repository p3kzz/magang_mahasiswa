...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu mt-3">
            ...
            <li><a class="nav-link" href="<?= url('dashboard') ?>"><i class="fas fa-fire"></i>
            ...
            <li class = ""><a class="nav-link" href="<?= url('data-pendaftaran') ?>"><i
                        class="fas fa-calendar-check"></i> <span>Data Pendaftaran <sup><span
                                class="subatas">{{ $data['pengajuan'] }}</span></sup> </a></li>
            <li class = ""><a class="nav-link" href="<?= url('data-sertifikat') ?>"><i
                        class="fas fa-calendar-check"></i> <span>Data Sertifikat </a></li>

            <li class="menu-header">Data Laporan</li>
            <li class = ""><a class="nav-link" href="<?= url('data-diterima') ?>"><i
                        class="fas fa-calendar-check"></i> <span>Data Diterima <sup><span
                                class="subatas">{{ $data['diterima'] }}</span></sup></span></a></li>
            <li class = ""><a class="nav-link" href="<?= url('data-tidak-diterima') ?>"><i
                        class="fas fa-calendar-check"></i> <span>Data Tidak Diterima <sup><span
                                class="subatas">{{ $data['tidak_diterima'] }}</span></sup></span></a></li>
        </ul>
